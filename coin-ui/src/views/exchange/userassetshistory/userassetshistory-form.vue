<template>
  <el-dialog
    ...
    <el-form-item label="数量变化" prop="amountDelta">
        <el-input v-model="dataForm.amountDelta" placeholder="数量变化"></el-input>
    </el-form-item>
...
<script>
    import {getObj, addObj, putObj} from '@/api/userassetshistory'
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          amountDelta: [
            { required: true, message: '数量变化不能为空', trigger: 'blur' }
          ],
