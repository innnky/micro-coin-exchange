  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="币种全称" prop="fullName">
        <el-input v-model="dataForm.fullName" placeholder="币种系统余额"></el-input>
      </el-form-item>
      <el-form-item label="币种描述" prop="coinDescription">
        <el-input v-model="dataForm.coinDescription" placeholder="币种系统余额"></el-input>
      </el-form-item>
