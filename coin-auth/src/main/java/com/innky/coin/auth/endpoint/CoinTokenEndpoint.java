...
package com.innky.coin.auth.endpoint;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.innky.coin.admin.api.entity.SysOauthClientDetails;
import com.innky.coin.admin.api.feign.RemoteClientDetailsService;
import com.innky.coin.admin.api.vo.TokenVo;
...
import com.innky.coin.common.core.util.SpringContextHolder;
import com.innky.coin.common.security.annotation.Inner;
import com.innky.coin.common.security.util.OAuth2EndpointUtils;
import com.innky.coin.common.security.util.OAuth2ErrorCodesExpand;
import com.innky.coin.common.security.util.OAuthClientException;
...
public class CoinTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new CoinAuthenticationFailureEventHandler();
