...
package com.innky.coin.codegen;

import com.innky.coin.common.datasource.annotation.EnableDynamicDataSource;
...
public class CoinCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(CoinCodeGenApplication.class, args);
	}
